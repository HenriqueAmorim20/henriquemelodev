<template>
  <div id="skills" class="main">
    <div class="header">
      <span class="header-order">02.</span>
      <span class="header-name">Main skills</span>
      <div class="header-divider" />
    </div>
    <v-row class="section">
      <v-col cols="12">
        <v-row class="section-skills">
...
.section-skills-card-content-progress {
