        ...
        <v-row class="project-card-content" align="center">
          ...
          <v-col cols="12">
            <p class="project-card-content-desc">
              ...
              private project for an outsourced company of the Ministry of Technology.
            </p>
          </v-col>
          <span style="flex: 1 1 auto"></span>
          <v-row class="project-card-tech" justify="center">
        ...
        <v-row class="project-card-content" align="center">
          ...
          <v-col cols="12">
            <p class="project-card-content-desc">
              ...
              etc. It's also a private project for an outsourced company of the Ministry of Technology.
            </p>
          </v-col>
          <span style="flex: 1 1 auto"></span>
          <v-row class="project-card-tech" justify="center">
