  ...
  <div id="projects" class="main">
    ...
    <v-row class="projects" justify="center">
      <v-card
        ...
        color="#1a192b"
      >
        <v-row class="project-card-header" align="center">
        ...
        <v-row class="project-card-content" align="center">
          <v-col cols="12">
            <span class="project-card-content-name">Loemi</span>
          </v-col>
          <v-col cols="12">
            <p class="project-card-content-desc">
              This website was built as a Floral Design portfolio for a florist
              in Brasilia. The idea of this project is to show the products in a
              minalistic yet beautiful way.
            </p>
          </v-col>
          <span style="flex: 1 1 auto"></span>
          <v-row class="project-card-tech" justify="center">
            <v-col align="center">
              <span>NuxtJS</span>
            </v-col>
            <v-col align="center">
      ...
      >
        ...
        <v-row class="project-card-content" align="center">
          <v-col cols="12">
            <span class="project-card-content-name">Bloco bsb</span>
          </v-col>
          <v-col cols="12">
            <p class="project-card-content-desc">
              This website was built for a local shirt brand from Brasília. The
              idea of this project is to help clients visualize the products and
      ...
      >
        ...
        <v-row class="project-card-content" align="center">
          <v-col cols="12">
            <span class="project-card-content-name">iSurvey</span>
          </v-col>
          <v-col cols="12">
            <p class="project-card-content-desc">
              This project is a survey/forms system, with a frontend for the
              user and a another frontend that is a forms configurator. It's a
              private project for an outsourced company of the Ministry of
              Technology.
            </p>
          </v-col>
          <span style="flex: 1 1 auto"></span>
      ...
      >
        ...
        <v-row class="project-card-content" align="center">
          <v-col cols="12">
            <span class="project-card-content-name">OCTI - Admin</span>
          </v-col>
          <v-col cols="12">
            <p class="project-card-content-desc">
              This project was built as an administrator system that manages,
              stores, creates and plots graphics for the website that is linked
              in this card.
            </p>
          </v-col>
          <span style="flex: 1 1 auto"></span>
      ...
      >
        ...
        <v-row class="project-card-content" align="center">
          <v-col cols="12">
            <span class="project-card-content-name">Neo</span>
          </v-col>
          <v-col cols="12">
            <p class="project-card-content-desc">
              This project is a complex intern manager of events, contracts,
              etc. It's also a private project for an outsourced company of the
